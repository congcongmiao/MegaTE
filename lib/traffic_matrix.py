...
class TrafficMatrix(object):
    ...
    def from_file(cls, fname):
        ...
        if model == 'gravity':
            ...
            return GenericTrafficMatrix(problem=None, tm=tm, seed=seed, scale_factor=scale_factor)
            
        elif model == 'nineone':
            return NineOneTrafficMatrix(problem=None, tm=tm, scale_factor=scale_factor)
...
class GenericTrafficMatrix(TrafficMatrix):
    def __init__(self, problem, tm, seed, scale_factor=1.0):
        assert tm is not None
        super().__init__(problem, tm, seed, scale_factor=scale_factor)
...
class NineOneTrafficMatrix(TrafficMatrix):
    ...
    def copy(self):
        return NineOneTrafficMatrix(self.problem, self._tm.copy())
