...
OUTPUT_DIR = '../topologies/site_topologies'
...
def add_bi_edge(G, src, dest, capacity=1000.0):
    G.add_edge(src, dest)
    G.add_edge(dest, src)
    if capacity:
...
def triangle():
    G = nx.DiGraph()
    G.add_node(0, label='0', pos=(-1, 0))
    G.add_node(1, label='1', pos=(0, 2))
...
def txb3():
    G = nx.DiGraph()
    G.add_node(0, label='0', pos=(0, 2))
    G.add_node(1, label='1', pos=(1, 2))
    G.add_node(2, label='2', pos=(-1, 1))
    G.add_node(3, label='3', pos=(1, 1))
    G.add_node(4, label='4', pos=(-1, 0))
